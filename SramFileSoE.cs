...
namespace SramFormat.SoE
{
    public class SramFileSoE : SramFile<Sram, SramGame>
    {
        ...
        public SramFileSoE(string filepath, FileRegion region) :base(filepath, Sizes.Sram, Sizes.Game.All, Offsets.FirstGame, 3)
        {
        ...
        protected override void OnLoad(Stream stream)
        {
	        base.OnLoad(stream);
