...
namespace SRAM.SoE.Models.Structs
{
	...
	[DisplayNameLocalized(nameof(Resources.StructSaveSlot), typeof(Resources))]
	[HasOffsetMembers]
	...
	public struct SaveSlotSoE
	{
		...
		public override string ToString() => Data.Format();
	}
	...
	[DisplayNameLocalized(nameof(Resources.StructSaveSlotData), typeof(Resources))]
	[HasOffsetMembers]
	[UseMemberGrouping]
	[StructLayout(LayoutKind.Sequential, Pack = 1)]	
